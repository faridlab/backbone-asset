...
| [0004](adr-0004-asset-lifecycle-gl-seam.md) | Asset boundary + the capitalize → depreciate → dispose GL seam (module-specific) | Accepted |

ADRs 0001–0003 are **framework** decisions (true of every Backbone module). ADR-0004 is this
**module's own** decision; its authoritative long form lives at
[`docs/adr/ADR-001-asset-boundary-and-lifecycle-seam.md`](../../adr/ADR-001-asset-boundary-and-lifecycle-seam.md).
