//! Domain policy for AssetDepreciationEntry aggregate
//!
...
/// Domain policy for AssetDepreciationEntry — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<AssetDepreciationEntry>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type AssetDepreciationEntryDomainPolicy = PermitAllPolicy<AssetDepreciationEntry>;
