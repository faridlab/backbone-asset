//! Specifications for AssetCategory aggregate
//!
...
// Each predicate implements `Specification<AssetCategory>` and can be combined
...
//
// pub struct ActiveAssetCategorySpec;
// impl Specification<AssetCategory> for ActiveAssetCategorySpec {
//     fn is_satisfied_by(&self, e: &AssetCategory) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
