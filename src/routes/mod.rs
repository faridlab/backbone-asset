...
/// Create stateless routes for the Assets module.
///
...
///
/// ```ignore
/// let module = AssetsModule::builder().with_database(pool).build()?;
/// let routes = create_stateless_routes(&module);
/// let app = Router::new().merge(routes);
/// ```
pub fn create_stateless_routes(module: &crate::AssetsModule) -> Router<()> {
    Router::new()
...
pub fn get_routes(module: &crate::AssetsModule) -> Router<()> {
    Router::new()
...
/// Create stateful routes for the Assets module.
///
...
pub fn create_combined_routes(module: &crate::AssetsModule) -> Router<AppState> {
...
/// Get all routes (stateful) for the Assets module.
///
/// This is a convenience function that wraps routes with API versioning.
pub fn get_routes_with_state(module: &crate::AssetsModule) -> Router<AppState> {
    Router::new()
